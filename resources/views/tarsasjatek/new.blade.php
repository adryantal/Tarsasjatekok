...
<header> <h1>Új rekord rögzítése</h1></header>
<div>

<form action="/api/tarsasjatek" method="POST">
        ...
        <fieldset>
            <div class="container-sm mt-3">
                ...
                <input type="text" class="form-control" id="nev_magyar" name="nev_magyar">  

                <label for="nev_angol" class="form-label">Társasjáték angol neve:</label>    
                <input type="text" class="form-control" id="nev_angol" name="nev_angol"> 
                ...
                <input type="number" class="form-control" id="jatekosok_szama" name="jatekosok_szama">

                <label for="jatekido" class="form-label">Játékidő:</label>    
                <input type="number" class="form-control" id="jatekido" name="jatekido">
                
                <label for="vasarlas_ideje" class="form-label">Vásárlás ideje:</label>    
                <input type="date" class="form-control" id="vasarlas_ideje" name="vasarlas_ideje">
